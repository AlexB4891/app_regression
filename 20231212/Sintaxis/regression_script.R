...
# execute_model(grupo = "_joint",population = "_all")

# Falta: Filtros para net profits >0, CIT > 0, panama vs colombia, panama vs pero, colombia vs th
# Añadir los años que faltan (prioridad 2)
