...
model_df <- model_df_0 %>% filter(model == "Firm clustered model with time and fixed effects"  )

model_df_p <- model_df_0_p %>% filter(model == "Firm clustered model with time and fixed effects"  )
